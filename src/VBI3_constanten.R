...
opp_V <- 13625.55 # opp Landoppervlakte sinds 2018
# (https://statbel.fgov.be/nl/themas/leefmilieu/grond/bodemgebruik) cfr advies INBO addendum 2020

opp_V_private <- 0.5*opp_V # dummy value
opp_V_public <- 0.5*opp_V  # dummy value
...
# sample sizes----
nTot_ANT <- 5750 + 3 #3 punten vallen uit de GIS-overlay met de provincies, maar behoren op zicht tot prov antwerpen
nTot_LIM <- 4848 + 3
nTot_LMB <- 4848 + 3
nTot_OVL <- 6019
nTot_WVL <- 6303 + 2
